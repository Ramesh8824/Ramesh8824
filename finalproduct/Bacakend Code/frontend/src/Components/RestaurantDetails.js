...
const openRazorPay=async ()=>{
    try{
        let data ;
       data = await fetch("https://zomato-final.herokuapp.com/pay/razorpay", {
            method: "POST",
      ...
      const options = {
        ...
        handler: function (response) {
            var values ={
              ...
              fetch("https://zomato-final.herokuapp.com/pay/transaction", {
                method: "POST",
                headers: { 'Content-Type': 'application/json' },
...
const loadScript = (src) => {
    ...
    useEffect(() => {
        fetch(`https://zomato-final.herokuapp.com/zomato/restaurantDetails/${rName}`,{method:'GET'})
        .then(response=>response.json())
        .then(data=>setRestaurant(data.data))
        

        fetch(`https://zomato-final.herokuapp.com/zomato/menu/${rName}`,{method:'GET'})
        .then(response=>response.json())
