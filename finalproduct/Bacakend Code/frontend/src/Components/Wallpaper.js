...
export default class Wallpaper extends Component {
  ...
  constructor(){
    ...
    componentDidMount(){
        ...
        //call my api 
        fetch('https://zomato-final.herokuapp.com/zomato/locations',{method:'GET'})
    ...
    fetchRestaurants = (event)=>{
        fetch(`https://zomato-final.herokuapp.com/zomato/restaurants/${event.target.value}`,{method:'GET'})
        .then(response=>response.json())
